...
bool is_colliding_with_border(const ShiftedMask &shifted_mask,
                              const std::array<uint64_t, kNumBitboardParts> &border);

bool
is_colliding(const ShiftedMask &shifted_mask, const std::array<uint64_t, kNumBitboardParts> &board);
